...
# methods
#--> how to make a scanner for input to enter user deposit?
#--> how to only print updated balance once all withdrawals, transfers, and depositis take place?
...
# user specific values -- # makes call to constructor of class and passes variables to create the object
...
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
---------------------------------------------------Concept notes:---------------------------------------------------------
-- Class  = blueprint of custom objects.
-- Construction function -- creates instance of an object
-- Instances = decalared variables of a class, follows pattern defined by class.
-- self = first parameter of method within class; reference of instance (not of class). (Like saying I, I am a humanbeing)
-- __init__ = magic method in pyton which has two underscores before and after init; used when new object is instatiated.
-- Attributes = characteristics shared by instances.
-- Methods = actions that objecs perform.


------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
---------------------------------------------------Tinkering zone:---------------------------------------------------------
    #--> how to scan and to allow user input and update xfer?
    #--> how to make a scanner for input to enter user deposit?
    #--> how to print updated main balance once all withdrawals, transfers, and depositis take place?
    #--> How to get dollar sign to auto-populate with method?
