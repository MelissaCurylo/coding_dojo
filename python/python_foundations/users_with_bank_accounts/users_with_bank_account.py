...
melissa.account["checking account"].withdraw(25)
melissa.account["saving account"].withdraw(49)
...
cody.account["checking account"].withdraw(18)
cody.account["saving account"].withdraw(18)
